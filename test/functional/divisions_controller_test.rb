...
class DivisionsControllerTest < ActionController::TestCase
  ...
  test "should create division" do
    assert_difference('Division.count') do
      post :create, division: { client_id: @division.client_id, location_id: @division.location_id, name1: @division.name1, name2: @division.name2, name: @division.name }
    end
  ...
  test "should update division" do
    put :update, id: @division, division: { client_id: @division.client_id, location_id: @division.location_id, name1: @division.name1, name2: @division.name2, name: @division.name }
    assert_redirected_to division_path(assigns(:division))
  end
